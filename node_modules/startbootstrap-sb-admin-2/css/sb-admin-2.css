...
.btn-primary {
  color: #fff;
  background-color: #29B896;
  border-color: #29B896;
}

.btn-primary:hover {
  color: #fff;
  background-color: #29A896;
  border-color: #29A896;
}
...
.bg-primary {
  background-color: #29B896 !important;
}
...
button.bg-primary:focus {
  background-color: #29A896 !important;
}
...
.text-primary {
  color: #29B896 !important;
}

a.text-primary:hover,
a.text-primary:focus {
  color: #29A896 !important;
}
...
.bg-gradient-primary {
  background-color: #29B896;
  background-image: linear-gradient(180deg, #29B896 10%, #29A896 100%);
...
.border-left-primary {
  border-left: 0.25rem solid #29B896 !important;
}

.border-bottom-primary {
  border-bottom: 0.25rem solid #29B896 !important;
}
